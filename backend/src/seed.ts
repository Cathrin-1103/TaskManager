...
export async function seedDatabase() {
  try {
    ...
    const task1 = new TaskModel({
      ...
      title: "Fix broken login button on mobile view",
      done: true,
      dueDate: tomorrow,
      ...
      comments: [
        {
          ...
          text: "Tested on iOS Safari, login works smoothly now!",
    ...
    const task2 = new TaskModel({
      ...
      authorEmail: alex.email,
      authorUsername: alex.username,
      title: "Update API endpoints for profile picture upload",
      done: false,
      dueDate: nextWeek,
      ...
      comments: [
        {
          ...
          text: "Currently integrating file upload middleware.",
